  ...
  async initAUT () {
    ...
    if (this.opts.uninstallOtherPackages) {
      ...
      try {
        ...
        log.errorAndThrow(`Could not parse "uninstallOtherPackages" capability: ${e.message}`);
      }
      // Only SETTINGS_HELPER_PKG_ID package is used by UIA1
      await helpers.uninstallOtherPackages(uninstallOtherPackages, this.adb, [SETTINGS_HELPER_PKG_ID]);
    }
