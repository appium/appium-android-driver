...
class AndroidDriver extends BaseDriver {
  ...
  async initAUT () {
    ...
    if (!this.opts.app) {
      ...
      await helpers.resetApp(this.adb, Object.assign({}, {fastReset: true}, this.opts));
      return;
    }
    if (!this.opts.skipUninstall || !this.opts.fastReset) {
      await this.adb.uninstallApk(this.opts.appPackage);
    }
    await helpers.installApk(this.adb, Object.assign({}, {fastReset: true}, this.opts));
