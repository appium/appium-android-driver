...
class AndroidDriver extends BaseDriver {
  ...
  async createSession (caps) {
    ...
    try {
      ...
      this.useUnlockHelperApp = true;
      if (typeof this.caps.unlockType === 'undefined') {
        this.useUnlockHelperApp = false;
      }
  ...
  async startAndroidSession () {
    ...
    // unlock the device using the HelperApp in case a user
    // dont set an unlock type
    if (this.useUnlockHelperApp === true) {
      await helpers.unlockWithHelperApp(this.adb);
    }
