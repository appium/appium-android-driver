...
class AndroidDriver extends BaseDriver {
  ...
  validateDesiredCaps (caps) {
    ...
    // make sure that the capabilities have one of `app` or `browser`
    if ((!caps.browserName || !helpers.isChromeBrowser(caps.browserName.toLowerCase())) &&
      !caps.app) {
      let msg = 'The desired capabilities must include either an app or browser';
