 ...
 * @property {!string} package The name of the application package to be cleared
 */
...
commands.mobileClearApp = async function mobileClearApp (opts = {}) {
  if (!opts.package) {
    throw new errors.InvalidArgumentError(`The 'package' argument is required`);
  }
  await this.adb.clear(opts.package);
};
