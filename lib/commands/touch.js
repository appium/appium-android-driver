 ...
 * @deprecated
 * @this {import('../driver').AndroidDriver}
 * @param {import('./types').TouchDragAction} gestures
 * @returns {Promise<void>}
 */
export async function doTouchDrag(gestures) {
 ...
 */
export async function fixRelease(gestures) {
 ...
 * @returns {Promise<void>}
 */
export async function performGesture(gesture) {
  try {
 ...
 */
export async function getSwipeOptions(gestures, touchCount = 1) {
 ...
 */
export async function parseTouch(gestures, multi) {
