 ...
 *
 * @param {object} opts - Object containing sensor type declared in adb.SENSORS items and value
 * @throws {Error} - If sensorType is not defined in opts
 * @throws {Error} - If value is not defined in opts
 * @throws {Error} - If deviceType is not an emulator
 */
commands.sensorSet = async function sensorSet (opts = {}) {
