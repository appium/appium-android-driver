...
commands.startActivity = function (appPackage, appActivity) {
  return this.adb.startApp({
    pkg: appPackage,
...
commands.reset = async function () {
  if (this.opts.fastReset) {
    ...
    return this.adb.stopAndClear(this.opts.appPackage);
  }

  log.info("Running old fashion reset (reinstall)");
  await this.adb.uninstallApk(this.opts.appPackage);
  return androidHelpers.installApkRemotely(this.adb, this.opts.app, this.opts.appPackage, this.opts.fastReset);
};
