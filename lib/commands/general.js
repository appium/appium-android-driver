 ...
 */
commands.getDeviceTime = async function (format = '+%Y-%m-%dT%T%z') {
  log.info('Attempting to capture android device date and time');

  if (!_.isString(format)) {
    log.errorAndThrow(`The format specifier is expected to be a valid string specifier like '+%Y-%m-%dT%T%z'. ` +
