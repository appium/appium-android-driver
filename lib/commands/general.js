 ...
 * @property {!string|Array<string>} permissions - The full name of the permission to be granted
 * or comma-separated list of permissions. Mandatory argument.
 ...
 * @throws {Error} if there was a failure while settings permissions
 */
