...
const GeneralMixin = {
  ...
  async getCurrentActivity() {
    return /** @type {string} */ ((await /** @type {ADB} */ (this.adb).getFocusedPackageAndActivity()).appActivity);
  },
  ...
  async getCurrentPackage() {
    return /** @type {string} */ ((await /** @type {ADB} */ (this.adb).getFocusedPackageAndActivity()).appPackage);
  },
