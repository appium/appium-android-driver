 ...
 * is not in the result if processes were not running during the period.
 *
 * @param {string} packageName The package name to get the CPU information.
 * @param {number} retries The number of retry count.
 * @returns {Array} The array of the parsed result. e.g. ['cpuinfo', ['14.3', '28.2']]
 *                  '14.3' is by the user (%), '28.2' is by the kernel (%)
 * @throew {Error} If it failed to parse the result of dumpsys, or no package name exists.
 */
