...
async function setupNewChromedriver (opts, curDeviceId, adb) {
  ...
  // strip `goog` prefix if it is given
  if (opts['goog:chromeOptions']) {
    opts.chromeOptions = opts['goog:chromeOptions'];
  }
