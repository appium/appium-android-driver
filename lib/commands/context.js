 ...
 */
commands.mobileGetContexts = async function mobileGetContexts(opts = {}) {
  const _opts = {
  ...
  return await webviewHelpers.getWebViewsMapping(this.adb, _opts);
};
...
helpers.setupNewChromedriver = async function setupNewChromedriver(
  opts,
  curDeviceId,
  adb,
  context = null,
