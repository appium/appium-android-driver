...
commands.mobilePerformStatusBarCommand = async function mobilePerformStatusBarCommand (opts = {}) {
  ...
  const toStatusBarCommandCallable = (cmd, ...args) => async () => await this.adb.shell([
    'cmd', 'statusbar', cmd, ...args
  ]);
  const statusBarCommands = {
    expandNotifications: toStatusBarCommandCallable('expand-notifications'),
    expandSettings: toStatusBarCommandCallable('expand-settings'),
    collapse: toStatusBarCommandCallable('collapse'),
    addTile: toStatusBarCommandCallable('add-tile', requireArgs('component', opts).component),
    removeTile: toStatusBarCommandCallable('remove-tile', requireArgs('component', opts).component),
    clickTile: toStatusBarCommandCallable('click-tile', requireArgs('component', opts).component),
    getStatusIcons: toStatusBarCommandCallable('get-status-icons'),
  };
