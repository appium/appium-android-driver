...
commands.performStatusBarCommand = async function performStatusBarCommand (opts = {}) {
  ...
  const statusBarCommands = {
    ...
    addTile: async () => {
      const {component} = requireArgs('component', opts);
      return await invokeStatusBarCommand('add-tile', component);
    },
    removeTile: async () => {
      const {component} = requireArgs('component', opts);
      return await invokeStatusBarCommand('remove-tile', component);
    },
    clickTile: async () => {
      const {component} = requireArgs('component', opts);
      return await invokeStatusBarCommand('click-tile', component);
    },
