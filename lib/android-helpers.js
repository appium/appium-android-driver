...
helpers.pushUnlock = async function (adb) {
  ...
  // the unlock helpers does not have the correct versioning, so
  // `adb.installOrUpgrade` will not work
  try {
    ...
    logger.debug(`Incompatible unlock helper found, remove old version and re-installing`);
