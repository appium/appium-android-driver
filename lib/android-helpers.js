...
const DEFAULT_SERVER_ARGS = {
  ...
  chromedriverExecutable: null,
  suppressKillServer: false,
};

helpers.parseKnownArgs = function (opts, allArgs, knownArgNames) {
...
helpers.parseArgs = function (opts, allArgs, knownArgNames) {
  let acc = helpers.parseKnownArgs(opts, allArgs, knownArgNames);
...
export { helpers, SETTINGS_HELPER_PKG_ID, prepareAvdArgs, ensureNetworkSpeed, DEFAULT_SERVER_ARGS };
