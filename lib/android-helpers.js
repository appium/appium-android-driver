...
helpers.createADB = async function (javaVersion, udid, emPort, remoteAdbHost, adbPort, suppressKillServer) {
  let adb = await ADB.createADB({javaVersion, remoteAdbHost, adbPort, suppressKillServer});
