 ...
 * @param {[string]} appPackages An array of package names to uninstall
 * @param {ADB} adb Instane of Appium ADB object
 */
helpers.uninstallOtherPackages = async function (appPackages, adb) {
