...
describe('Unlock Helpers', function () {
  ...
  describe('validateUnlockCapabilities', function () {
    ...
    it('should verify the unlock keys for pin/pinWithKeyEvent', function () {
      for (const invalidValue of [undefined, ' ', '1abc']) {
        ...
        expect(() => helpers.validateUnlockCapabilities(toCaps('pinWithKeyEvent', invalidValue))).to
          .throw;
      }
    ...
    it('should verify the unlock keys for fingerprint', function () {
      for (const invalidValue of [undefined, ' ', '1abc']) {
        expect(() => helpers.validateUnlockCapabilities(toCaps('fingerprint', invalidValue))).to
          .throw;
      }
  ...
  describe(
    'pinUnlock',
    withMocks({adb, helpers, driver, asyncbox}, (mocks) => {
  ...
  describe(
    'patternUnlock',
    withMocks({driver, helpers, adb, asyncbox}, (mocks) => {
      const el = {ELEMENT: 1};
      const pos = {x: 10, y: 20};
