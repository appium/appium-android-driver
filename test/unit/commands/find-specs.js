...
describe('Find', () => {
  ...
  describe('doFindElementOrEls', () => {
    it('should send find action to bootstrap', async () => {
  ...
  describe('findElorEls', () => {
    ...
    it('should be able to find elements', async () => {
    ...
    it('should not throws NoSuchElementError when searching multiple if element does not exist', async () => {
      driver.doFindElementOrEls.returns(null);
      await driver.findElOrEls('xpaht', '//*[1]', true)
        .should.eventually.be.deep.equal([]);
    });
    it('should throws NoSuchElementError if element does not exist', async () => {
    ...
    it('should fails if locator strategy is not valid', async () => {
      driver.validateLocatorStrategy.throws();
      await driver.findElOrEls().should.be.rejected;
    });
    it('should fails if gets unexpected error', async () => {
