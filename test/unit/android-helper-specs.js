...
import helpers, {prepareAvdArgs, ensureNetworkSpeed} from '../../lib/helpers/android';
import ADB from 'appium-adb';
import {withMocks} from '@appium/test-support';
import {fs} from '@appium/support';
import unlocker from '../../lib/helpers/unlock';
...
describe('Android Helpers', function () {
  ...
  describe(
    ...
    withMocks({adb, helpers}, (mocks) => {
      ...
      it('should launch avd if one is not running', async function () {
        mocks.adb.expects('getRunningAVDWithRetry').withArgs('foobar').throws();
        mocks.adb
          .expects('launchAVD')
  ...
  describe(
    'installApk',
    withMocks({adb, fs, helpers}, function (mocks) {
  ...
  describe(
    ...
    withMocks({adb, fs}, (mocks) => {
      it('should return {} because of no app, no package and no app in the target device', async function () {
        ...
        mocks.adb
          .expects('pullApk')
          .withExactArgs(opts.appPackage, opts.tmpDir)
      ...
      it('should extracts string.xml and converts it to string.json and pushes it', async function () {
        ...
        mocks.adb
          .expects('extractStringsFromApk')
          .withArgs(opts.app, 'en')
