...
describe('performance', () => {
  ...
  describe('getPerformanceData', function () {
    ...
    it('should get the remaining battery power', async () => {
      let battery = await driver.getPerformanceData('io.appium.android.apis', 'batteryinfo', 1000);
    ...
    it('should get the network statistics', async () => {
      let network = await driver.getPerformanceData('io.appium.android.apis', 'networkinfo', 1000);
