...
describe('Find - uiautomator', function () {
  ...
  it('should find elements without prepending "new UiSelector()"', async function () {
    await driver
      .findElements('-android uiautomator', '.clickable(true)')
      .should.eventually.have.length.at.least(10);
  });
  it('should find elements without prepending "new UiSelector()"', async function () {
    await driver
  ...
  it('should find elements without prepending "new "', async function () {
    await driver
      .findElements('-android uiautomator', 'UiSelector().clickable(true)')
      .should.eventually.have.length.at.least(10);
  });
  ...
  it('should find an element with a string argument', async function () {
    await driver.findElement('-android uiautomator', 'new UiSelector().description("Animation")')
  ...
  it('should find an element with a long chain of methods', async function () {
    let el = await driver.findElement(
      '-android uiautomator',
      'new UiSelector().clickable(true).className(android.widget.TextView).index(1)'
    );
  ...
  it('should find an element with recursive UiSelectors', async function () {
    ...
    await driver
      .findElements(
        '-android uiautomator',
        'new UiSelector().childSelector(new UiSelector().clickable(true)).clickable(true)'
      )
  ...
  it('should not find an element with bad syntax', async function () {
    await driver
      .findElements('-android uiautomator', 'new UiSelector().drinkable(true)')
  ...
  it('should not find an element which does not exist', async function () {
    await driver
      .findElements('-android uiautomator', 'new UiSelector().description("chuckwudi")')
      .should.eventually.have.length(0);
  });
  it('should allow multiple selector statements and return the Union of the two sets', async function () {
    let clickable = await driver.findElements(
      '-android uiautomator',
      'new UiSelector().clickable(true)'
    );
    clickable.length.should.be.above(0);
    let notClickable = await driver.findElements(
      '-android uiautomator',
      'new UiSelector().clickable(false)'
    );
    notClickable.length.should.be.above(0);
    let both = await driver.findElements(
      '-android uiautomator',
  ...
  it('should allow multiple selector statements and return the Union of the two sets', async function () {
    ...
    clickable.length.should.be.above(0);
    let clickableClickable = await driver.findElements(
      '-android uiautomator',
      'new UiSelector().clickable(true); new UiSelector().clickable(true);'
    );
  ...
  it('should find an element in the second selector if the first finds no elements', async function () {
    ...
    await driver.findElements('-android uiautomator', selector).should.eventually.exist;
  });
  ...
  it('should allow chaining UiScrollable methods', async function () {
    let selector =
      'new UiScrollable(new UiSelector().scrollable(true).instance(0)).setMaxSearchSwipes(10).scrollIntoView(new UiSelector().text("Views").instance(0))';
    let el = await driver.findElement('-android uiautomator', selector);
    await driver.getText(el.ELEMENT).should.eventually.equal('Views');
  });
  ...
  it('should parse commas in quotes correctly', async function () {
    ...
    let selector =
      'new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text("One thing, another thing, and yet a third.").instance(0));';
    await driver
      .findElement('-android uiautomator', selector)
  ...
  it('should error reasonably if a UiScrollable does not return a UiObject', async function () {
    let selector =
      'new UiScrollable(new UiSelector().scrollable(true).instance(0)).setMaxSearchSwipes(10)';
    await driver
      .findElement('-android uiautomator', selector)
